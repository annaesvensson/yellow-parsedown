...
<p align="center"><img src="parsedown-screenshot.png?raw=true" alt="Screenshot"></p>
...
The default parser is defined in file `system/extensions/yellow-system.ini`. A different parser can be defined in the [page settings](https://github.com/annaesvensson/yellow-core#settings-page) at the top of each page, for example `Parser: parsedown`.

## Installation

[Download extension](https://github.com/annaesvensson/yellow-parsedown/archive/main.zip) and copy zip file into your `system/extensions` folder. Right click if you use Safari.
